...
<!-- <?php echo form_hidden('article_id',$article->id) ?> -->
  <div class="form-group">
    ...
    <?php echo form_input(['class'=>'form-control','placeholder'=>'Enter Article Title','type'=>'text','name'=>'article_title','value'=>set_value('article_title',$article->article_title)]);?>
    <?php echo form_error('article_title',"<div class='text-danger'>","</div>"); ?>
  </div>
  <div class="form-group">
    <label for="pass">Article Body</label>
    <?php echo form_textarea(['class'=>'form-control','placeholder'=>'Enter Article Body','type'=>'text','name'=>'article_body','value'=>set_value('article_body',$article->article_body)]);?>
